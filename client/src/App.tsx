        ...
        <div className="relative z-10 text-center">
          ...
          <div className="mb-8 relative">
            <div className="w-32 h-32 mx-auto mb-6 relative">
              <Crown className="w-full h-full text-[#007BFF] drop-shadow-2xl animate-pulse shadow-[0_0_30px_#007BFF]" style={{filter: 'drop-shadow(0 0 20px #007BFF)', borderRadius: '20px'}} />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center space-x-4">
              <div className="w-12 h-12 bg-gradient-to-r from-[#007BFF] to-[#0056CC] rounded-2xl flex items-center justify-center relative shadow-[0_0_25px_#007BFF] border-2 border-[#007BFF]/40">
                <Crown className="h-7 w-7 text-white" style={{borderRadius: '12px'}} />
                ...
                <div className="absolute inset-0 bg-[#007BFF]/30 rounded-2xl blur-lg"></div>
              </div>
              ...
              <div className="text-center mb-20">
                <div className="mb-12">
                  <div className="w-40 h-40 mx-auto mb-12 relative">
                    <div className="w-full h-full bg-gradient-to-r from-[#007BFF] via-[#0099FF] to-[#007BFF] rounded-3xl p-2 animate-pulse shadow-[0_0_50px_#007BFF] border-4 border-[#007BFF]/20">
                      <div className="w-full h-full bg-black rounded-2xl flex items-center justify-center overflow-hidden relative border-3 border-[#007BFF]/60">
                        {/* Avatar Image */}
                        {!avatarError ? (
                          <img 
                            src={avatarUrl} 
                          ...
                          /* Crown Fallback */
                          <Crown className="h-20 w-20 text-[#007BFF]" style={{filter: 'drop-shadow(0 0 10px #007BFF)', borderRadius: '20px'}} />
                        )}
                      </div>
                    </div>
