                ...
                <div className="mb-12">
                  ...
                  <div className="flex flex-wrap justify-center gap-6 text-lg text-white/90 mb-6">
                    <div className="flex items-center space-x-2">
                      <MapPin className="w-5 h-5 dynamic-text-primary" />
                      <span>Italy</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Clock className="w-5 h-5 dynamic-text-primary" />
                      <span>{italyTime} CET</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      ...
                      <span className={isOnline() ? 'text-green-400' : 'text-gray-400'}>
                        {isOnline() ? 'Divine Presence Active' : 'Transcendent Meditation'}
                      </span>
                    </div>
                  </div>
                </div>
